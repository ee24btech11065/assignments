...
\draw(17.75,18.75) node {$\theta$};
\draw(18.25,18.25) arc[start angle =180,end angle = 245,radius = 0.75];
\draw(18.5,19) arc[start angle = 135,end angle =180,radius =1];
\draw(17.75,17.75) node{$\theta$};
...
\draw [line width=0.3pt,->,>=Stealth] (18.25,18.45)--(18.25,18.25);
\draw[line width = 0.3pt,->,>=Stealth] (18.25,18.20)--(18.25,18.25);
\draw [line width=0.7pt, short] (15.25,19.5) -- (18.75,21.5);
\draw [line width=0.3pt,->,>=Stealth] (18.30,18.75)--(18.55,19);
\draw [line width=0.3pt,->,>=Stealth] (18.60,17.68)--(18.75,17.60);
