...
\begin{enumerate}
    ...
    \item A foundry has a fixed daily cost of Rs 50,000 whenever it operates and a variable cost of Rs 800$Q$ where $Q$ is the daily production in tonnes. What is the cost of production in Rs per tonne for a daily production of 100 tonnes? \\ 
...
\begin{multicols}{4}
    ...
    \input{figure}
\item If 1,0 and -1 are the eigenvalues of a 3x3 matrix $A$, then the trace of $A^2 + 5A$ is equal to \underline{\hspace{2cm}}.\\

\item Which of the following is a solution of the differential equation\\ $x^2y^\prime + xy^{\prime\prime}+ y = 4\sin{\ln{x},x>0?}$
\begin{enumerate}
    \item $y = 2x\sin{\ln{x}}$
    \item $y = -2x\sin{\ln{x}}$
    ...
    \item $y = 2\ln{x}\cos{\ln{x}}$
\end{enumerate}
\item At $Z = 0$, the complex function $f\brak{Z} = Z\abs{Z}^2$
\begin{enumerate}
